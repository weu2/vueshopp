    ...
    methods:{
      addshopcart(){
        let params={
          ...
          skuNum:this.$route.params.skuNum,
        }
        this.$store.dispatch('addshopcartList', params)
        console.log("router",this.$route.params.skuID)
      },
      getshopcart(){
        this.$store.dispatch('getshopcartList')
        // console.log("router",this.$route.params.skuID)
        var delist=sessionStorage.getItem('detaildata');
       let goodEntity=JSON.parse(delist)
        console.log("good",goodEntity.categoryView);
        this.datalist.push(goodEntity)
